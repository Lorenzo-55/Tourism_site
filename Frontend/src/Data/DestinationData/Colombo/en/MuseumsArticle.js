const MuseumsArticle = {
  ...
  hero: {
    ...
    subtitle: "",
    backgroundImage: "/Destinations/Colombo/museums/museums-hero.webp",
  },
  ...
  sections: [
    {
      ...
      items: [
        {
          image: "/Destinations/Colombo/museums/national-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/natural-history.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/independence-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/dutch-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/economic-history.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/maritime-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/gangaramaya.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/postal-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/jrj-museum.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/old-town-hall.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/mmca.webp",
        ...
        {
          image: "/Destinations/Colombo/museums/bawa-number-11.webp",
...

    {
      ...
      align: "left",
      content: [
        { type: "h3", text: "Colombo National Museum" },
        ...
        { type: "h3", text: "National Museum of Natural History" },
        ...
        { type: "h3", text: "Independence Memorial Museum" },
...

    {
      ...
      align: "left",
      content: [
        { type: "h3", text: "Colombo Dutch Museum" },
        ...
        { type: "h3", text: "Old Town Hall Building and Museum" },
        ...
        { type: "h3", text: "Colombo Port Maritime Museum" },
...

    {
      ...
      align: "left",
      content: [
        { type: "h3", text: "Economic History Museum of Sri Lanka" },
        ...
        { type: "h3", text: "National Postal Museum" },
        ...
        { type: "h3", text: "J.R. Jayewardene Centre & Museum" },
...

    {
      ...
      align: "left",
      content: [
        { type: "h3", text: "Gangaramaya Temple Museum" },
        ...
        { type: "h3", text: "Museum of Modern and Contemporary Art Sri Lanka" },
        ...
        { type: "h3", text: "National Art Gallery" },
        ...
        { type: "h3", text: "Number 11 – Geoffrey Bawa’s Residence" },
...

    {
      ...
      align: "left",
      content: [
        { type: "h3", text: "Sri Lanka Air Force Museum" },
        ...
        { type: "h3", text: "Traditional Puppet Art Museum" },
...

    {
      ...
      image: "/Destinations/Colombo/museums/practical-info.webp",
