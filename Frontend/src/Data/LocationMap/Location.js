...
export const locations = [
  ...
  //======================= National Parks =======================
    ...
    importance: 1,
      ...
      {
    id: "angammedilla-national-park",
    name: "Angammedilla National Park",
    slug: "angammedilla-national-park",
    type: "park",
    x: 52,
    y: 50,
    summary: "A national park in Sri Lanka known for its diverse wildlife, including elephants, leopards, and various bird species.",
    importance: 1,
  },
  {
    ...
    x: 62,
    y: 85,
    summary: "A national park in Sri Lanka known for its wetlands, birdlife, and diverse ecosystems.",
    importance: 1,
  },
    {
    id: "ellakanda-national-park",
    name: "Ellakanda National Park",
    slug: "ellakanda-national-park",
    type: "park",
    x: 44,
    y: 88,
    summary: "A national park in Sri Lanka known for its diverse flora and fauna, including elephants, leopards, and various bird species.",
    importance: 1,
  },
    {
    id: "hiyare-reservoir",
    name: "Hiyare Reservoir",
    slug: "hiyare-reservoir",
    type: "park",
    x: 38,
    y: 84,
    summary: "A reservoir and nature reserve in Sri Lanka known for its biodiversity, including various bird species, reptiles, and mammals.",
    importance: 1,
  },
      {
    id: "seven-virgins-mountain-range",
    name: "Seven Virgins Mountain Range",
    slug: "seven-virgins-mountain-range",
    type: "park",
    x: 41,
    y: 68,
    summary: "A mountain range in Sri Lanka known for its scenic beauty, hiking trails, and diverse flora and fauna.",
    importance: 1,
  },

  {
    id: "kalametiya-bird-sanctuary",
    name: "Kalametiya Bird Sanctuary",
    slug: "kalametiya-bird-sanctuary",
    type: "park",
    x: 54,
    y: 87,
    summary: "A bird sanctuary in Sri Lanka known for its diverse bird species and natural habitat.",
    importance: 1,
  },
  {
    id: "hurulu-eco-park",
    name: "Hurulu Eco Park",
    slug: "hurulu-eco-park",
    type: "park",
    x: 50,
    y: 42,
    summary: "A eco park in Sri Lanka known for its diverse flora and fauna and natural habitat.",
    importance: 1,
  },
  {
    id: "kaudulla-national-park",
    name: "Kaudulla National Park",
    slug: "kaudulla-national-park",
    type: "park",
    x: 53,
    y: 44,
    summary: "A national park in Sri Lanka known for its diverse wildlife, including elephants, leopards, and various bird species.",
  ...
  },
  {
    ...
    {
    id: "lunugamvehera-national-park",
    name: "Lunugamvehera National Park",
    slug: "lunugamvehera-national-park",
    type: "park",
    x: 66,
    y: 76,
    summary: "A national park in Sri Lanka known for its diverse wildlife, including elephants, leopards, and various bird species.",
  ...
  {
    id: "makandawa-forest-reserve",
    name: "Makandawa Forest Reserve",
    slug: "makandawa-forest-reserve",
    type: "park",
    x: 35,
    y: 67,
    summary: "A forest reserve in Sri Lanka known for its diverse flora and fauna and natural habitat.",
    importance: 1,
  },
  {
    id: "minneriya-national-park",
  ...
  {
    id: "sinharaja-rainforest",
    name: "Sinharaja Rainforest",
    slug: "sinharaja-rainforest",
    type: "park",
    x: 35,
    y: 82,
    summary: "A forest reserve in Sri Lanka known for its rich biodiversity, including various endemic species of flora and fauna.",
    importance: 1,
  },
  {
